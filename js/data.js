 ...
 * 부모는 콘텐츠에 직접 나오는 분들만 적었다 (원이 어머니 김덕연 씨는
 * "이모, 저 덕연이 딸인데요" 라는 원이 본인의 대사로 밈이 됐고, 가족 단톡방 이름도
 * 「덕연이네 가족 야호」다). 성함이 공개되지 않은 분은 역할만 남긴다.
 */
export const MEMBERS = [
  {
    ...
    family: [
      { rel: '어머니', name: '김덕연', note: '「이모, 저 덕연이 딸인데요. 밥은 줍니까?」 — 거제 1편. 가족 단톡방 이름이 「덕연이네 가족 야호」다' },
      { rel: '아버지', note: '1969년생. 회사 관계자가 “팀에 미나미가 있다”고 한 걸 “팀에 미남이 있다”로 알아들어 원이가 입사를 못 할 뻔했다' },
      { rel: '오빠 · 여동생', note: '2000년생 · 2006년생' },
  ...
  },
  {
    ...
    family: [
      { rel: '어머니', note: '수원 매산초등학교 근무. 그 학교에 리센느를 좋아하는 어린 팬이 있어 행사 요청이 들어왔고, 무대도 없는 흙바닥 운동장 공연이 성사됐다' },
    ],
    nick: [
