...
export const MEMBERS = [
  ...
  },
  {
    ...
    nick: [
      ...
      { n: '무리브', why: '개그 욕심에 늘 무리수를 던져서 — 미나미가 라이브에서 처음 불렀다' },
      { n: '진리브', why: '팬을 놀리는 걸 좋아하는 모드 — 소심한 「리센느리브」 모드와 번갈아 나온다' },
    ],
  },
  {
    ...
    nick: [
      { n: '갸루귀신', why: '안원잘부 갸루 콘셉트 — 평소 한국어 말투와 차이가 너무 커서 「갸루귀신이 몸에 들어갔다 나왔다 하냐」고. 정통은 어머니한테 배운 것이다' },
      { n: '미남이', why: '원이 아버지가 「미나미」를 「미남이」로 알아들어서' },
      { n: '거제 홍보대사', why: '거제 편에 원이보다 더 신나 있었다고' },
      { n: '오죠사마', why: '「미나미의 뿌리를 찾아서」 치바편에서 보여 준 아가씨 모습' },
    ],
  },
  {
    ...
    nick: [
      ...
      { n: '초딩 메이', why: '지금도 하는 짓이 초딩 같아서. 마침 장촌초 4-2반 뮤직비디오까지 파묘됐다' },
    ],
  },
  {
...
export const EVENTS = [
  ...
  },
  {
    ...
    kind: 'viral',
    photo: ['minami', 'zena'],
    title: '「연습생 기간이 그것밖에 안 돼?」',
    meta: '「의외라는 리센느 연습생 기간?」 · 언제나영원이 · 154만',
    desc:
      '역주행 뒤 사람들이 뒤늦게 확인한 것 중 하나. 미나미는 2022년 2월 「방과후 설렘」에서 떨어져 일본으로 돌아갔다가 더뮤즈로 옮겼고, 제나는 2022년 6월 「청춘스타」 본선 2차에서 떨어진 뒤 더뮤즈에 들어왔다. 데뷔가 2024년 3월 26일이니 그때부터 세면 각각 2년 1개월, 1년 9개월이다. 몇 년을 갈아 넣고도 데뷔를 못 하는 게 흔한 판에서 짧은 축이고, 그 짧은 기간을 지나 나온 팀이 2년을 더 버텨 역주행했다는 게 이 시간선의 앞쪽 절반이다.',
    line: 'nexus',
    angle: 22,
    length: 240,
    labelOff: [12, -10],
    videos: [
      { id: '7XoG5n1o8LE', t: '의외라는 리센느 연습생 기간?', c: '① 2026. 06. 22 · 언제나영원이 · 154만', hi: true, s: true },
      { id: 'dUjXDqSFILI', t: '리센느는 어떻게 데뷔했을까? — 데뷔 비하인드', c: '② 인플루 KPOP · 20만' },
    ],
  },
  {
    id: 'fanart',
